...
// ═══════════════════════════════════════════════════════════════════════════════
// Pricing Game instructor dashboard.
//
...
// pricingSyncRoster / pricingGetReport / pricingScoreAndRecord, which later slices
// add. What this proves today is that an instructor can land here from the
// classroom, exchange the JWT via pricingInstructorSession, and be authenticated
// for the pricing_ collections.
// ═══════════════════════════════════════════════════════════════════════════════
